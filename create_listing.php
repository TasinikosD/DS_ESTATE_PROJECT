...
<html>
    ...
    <header class="header">
        ...
        <ul class="menu">
            <li><a href="http://localhost/DS_Estate_Website/feed(login).php">Feed</a></li>
            <li><a href="http://localhost/DS_Estate_Website/create_listing.php">Create Listing</a></li>
            <li><a href="http://localhost/DS_Estate_Website/login.php">Logout</a></li>
        </ul>
    </header>
    <body>
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"]="POST"){
                if(isset($_POST['submit'])) {
                    ...
                    if($countfiles-1==0){
                        echo 'Το ανέβασμα έστω δύο φωτογραφιών του ακινήτου είναι υποχρεωτικό';
                    }
                    ...
                    if($countfiles-1>0 && $k==0){
                        ...
                        header("Location: http://localhost/DS_Estate_Website/feed(login).php");
                        exit();
                    }
                }
            }
