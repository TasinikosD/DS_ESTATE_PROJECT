...
<html>
    ...
    <header class="header">
        ...
        <ul class="menu">
            <li><a href="http://localhost/DS_Estate_Website/feed.php">Feed</a></li>
            <li><a href="">Create Listing</a></li>
            <li><a href="http://localhost/DS_Estate_Website/login.php">Login</a></li>
        </ul>
    </header>
    <body>
        <div class='ΔΙΑΜΕΡΙΣΜΑ1'>
            ...
            <h2>Εάν δεν έχετε λογαριασμό κάντε <a class="register" href="http://localhost/DS_Estate_Website/register.php">Register</a></h2><br><br>  
        <?php
